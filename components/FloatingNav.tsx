      ...
      {navItems.map((item) => {
        ...
        return (
          <a
            ...
            title={item.label}
            className={`relative flex items-center justify-center w-[50px] h-[50px] rounded-full transition-all duration-200 hover:scale-105${"hideOnDesktop" in item && item.hideOnDesktop ? " lg:hidden" : ""}`}
            style={{
              background: "#D4D4D4" ,
            }}
          >
